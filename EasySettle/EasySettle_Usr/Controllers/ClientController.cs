...
namespace EasySettle.Controllers
{
    public class ClientController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClientID,FirstName,LastName,Email,telNo")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClientID,FirstName,LastName,Email,telNo")] Client client)
        {
